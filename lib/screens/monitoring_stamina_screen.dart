...
class _MonitoringStaminaScreenState extends State<MonitoringStaminaScreen> {
  String _selectedPlayer = 'Fede Valverde';
  String _intensitas = 'Medium';
  List<Map<String, dynamic>> _players = [];

  @override
  void initState() {
    super.initState();
    // 1. Memulai Koneksi Socket.IO (akan me-reuse koneksi yang ada)
    SocketService().connect();

    // 2. Meminta data paling baru seketika layarnya dibuka! (Agar tidak tertahan di status MEMUAT)
        ...
        actions: [
          const Padding(
            ...
            child: CircleAvatar(
              ...
              radius: 18,
              backgroundImage: const AssetImage('assets/images/pelatih.jpg'),
            ),
          ),
        ],
      ),
