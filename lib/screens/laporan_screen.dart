...
class _LaporanScreenState extends State<LaporanScreen> {
  String _selectedPeriode = 'Minggu Ini';
  ...
  final List<Map<String, dynamic>> _reportTypes = [
    {
      ...
      'subtitle':
          'Statistik individu lengkap: rating, sprint, assist, dan kesalahan',
    ...
    },
    {
      ...
      'subtitle':
          'Pola rata-rata penggantian pemain berdasarkan riwayat match',
  ...
  void _updateReports() {
    ...
    if (bestRule.length > 12) {
      bestRule = bestRule.substring(0, 10) + '..'; // Truncate so UI doesn't break
    }
  ...
  Future<void> _exportExcel() async {
    ...
    try {
      ...
      // Cleanup default sheet if multiple sheets exist and "Sheet1" is empty/unused
